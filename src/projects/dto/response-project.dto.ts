...
export class ResponseProjectDto {
  ...
  constructor(data: Project) {
    ...
    this.i003f_i011_tipo_proyecto = data.i003f_i011_tipo_proyecto
      ? new ResponseTypeProjectDto(data.i003f_i011_tipo_proyecto)
      : null;
    this.i003f_i010t_area_tecnica = data.i003f_i010t_area_tecnica
      ? new ResponseTechnicalAreaDto(data.i003f_i010t_area_tecnica)
      : null;
    ...
    this.i0003f_i008t_equipo_trabajo = data.i0003f_i008t_equipo_trabajo
      ? new ResponseTeamDto(data.i0003f_i008t_equipo_trabajo)
      : null;
    this.i003f_i005t_fase_entrada = data.i003f_i005t_fase_entrada
      ? new ResponsePhaseInputDto(data.i003f_i005t_fase_entrada)
      : null;
    this.i003f_i006t_estado_entrada = data.i003f_i006t_estado_entrada
      ? new ResponseInputStatusDto(data.i003f_i006t_estado_entrada)
      : null;
    this.i003f_i004t_datos_adi = data.i003f_i004t_datos_adi
      ? new ResponseAdditionalDatumDto(data.i003f_i004t_datos_adi)
      : null;
