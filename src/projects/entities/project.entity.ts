...
export class Project {
  ...
  @ManyToOne(
    () => TechnicalArea,
    (technicalArea) => technicalArea.i010i_area_tecnica,
  ...
  @ManyToOne(
    () => TypeProject,
    (typeProject) => typeProject.i011i_tipo_proyecto,
    { cascade: true, nullable: true, onDelete: 'CASCADE' },
  )
  @JoinColumn()
  ...
  @ApiProperty()
  @OneToOne(() => Team, (team) => team.c008i_equipo_trabajo, {
    cascade: true,
    nullable: true,
    onDelete: 'CASCADE',
  })
  ...
  @ManyToOne(
    () => PhaseInput,
    (projectsPhase) => projectsPhase.i0005i_fase_entrada,
    {
      cascade: true,
      nullable: true,
      onDelete: 'CASCADE',
  ...
  i003f_i005t_fase_entrada: PhaseInput = {
    i0005i_fase_entrada: 3,
    in_nombre_fase: 'Solicitud',
    tx_descripcion_fase: 'Fase de Solicitud',
  };

  @ApiProperty()
  @ManyToOne(
    () => InputStatus,
    (inputStatus) => inputStatus.i006i_estado_entrada,
    {
      cascade: true,
      nullable: true,
      onDelete: 'CASCADE',
  ...
  i003f_i006t_estado_entrada: InputStatus = {
    i006i_estado_entrada: 1,
    in_nombre_estado: 'Revision',
    tx_descripcion_estado: 'Estado de Revision',
  };

  @ApiProperty()
  @OneToOne(
    () => AdditionalDatum,
    (additionalDatum) => additionalDatum.i004i_datos_adi,
    {
      cascade: true,
      nullable: true,
      onDelete: 'CASCADE',
  ...
  @OneToMany(
    () => UserHistory,
    (user_history) => user_history.i013f_i003t_entrada,
    { cascade: true, nullable: true, onDelete: 'CASCADE' },
  )
  i003f_i007i_historia_usuario: UserHistory[];

  @ApiProperty()
  @OneToMany(() => Cost, (cost) => cost.i016f_i003t_entrada, {
    cascade: true,
    nullable: true,
    onDelete: 'CASCADE',
    /* orphanedRowAction: "delete"  */
